...
$urls=[
    [
        ...
        'hits'=>234,
        'last_modified'=>'10/02/2022 h 08:10',
    ...
    [
        ...
        'img'=>'https://fakeimg.pl/250x200/',
        'hits'=>212,
        'last_modified'=>'10/02/2022 h 18:10',
    ],
    [
        'name'=>'facebook',
        ...
        'img'=>'https://fakeimg.pl/250x200/',
        'hits'=>156,
        'last_modified'=>'10/02/2022 h 19:10'
    ],  
    [
        'name'=>'nasa',
        'url'=>'https://www.nasa.gov',
        ...
        'img'=>'https://fakeimg.pl/250x200/',
          'hits'=>178,
          'last_modified'=>'10/02/2022 h 17:10'
...
foreach($urls as $url){
   echo '<div class="col">';
    ...
    echo'<small class="text-muted">'. $url['last_modified'].'</small>';
